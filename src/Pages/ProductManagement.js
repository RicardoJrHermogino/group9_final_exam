                    ...
                    <table className=' text-center' style={{width:'100%', fontSize:'90%'}}>
                        ...
                        {products.map((product) => (
                            <tr key={product.id}>
                                ...
                                <td> 
                                <button onClick={() => startEditing(product)} className="btn btn-sm btn-secondary" style={{ borderRadius: '15px', width: '30%' }}>Edit</button>
                                <button onClick={() => handleDeleteProduct(product.id)} className="btn btn-sm btn-secondary" style={{ borderRadius: '15px', width: '30%' }}>Delete</button>  
                                </td>
                            </tr>
                            ))}
                        </tbody>
